...
class JobData(SourceDataDemo):
    ...
    def __init__(self):
        ...
        """
        super().__init__()
        self.title = '北京市公交线路数据总览'
        self.counter = {'name': '有约', 'value': 270665}
        self.counter2 = {'name': '无约', 'value': 11059}
        self.echart1_data = {
            'title': '最拥堵的线路',
            'data': [
                {"name": "1号线", "value": 40215},
                {"name": "2号线", "value": 17112},
                {"name": "3号线", "value": 17022},
                {"name": "4号线", "value": 16863},
                {"name": "5号线", "value": 15705},
                {"name": "6号线", "value": 11718},
            ]
        }
        self.echart2_data = {
            'title': '最拥堵的站点',
            'data': [
                {"name": "三路居", "value": 8991},
                {"name": "西单商城", "value": 2076},
                {"name": "东单路口南", "value": 8317},
                {"name": "金蝉西路南", "value": 842}
            ]
        }
        self.echarts3_1_data = {
            'title': '通勤时间',
            'data': [
                {"name": "0.5h", "value": 2105},
                {"name": "1h", "value": 21761},
                {"name": "1.5h", "value": 1025},
                {"name": "2h", "value": 4917}
            ]
        }
        self.echarts3_2_data = {
            ...
            'data': [
                {"name": "5m", "value": 84910},
                {"name": "15m", "value": 21530},
                {"name": "30m", "value": 56152},
                {"name": "45m", "value": 1574}
            ]
        }
