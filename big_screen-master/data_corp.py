...
class CorpData(SourceDataDemo):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.title = '全国公交大数据'
        self.counter = {'name': '公交总数量（全国）', 'value': 46897675}
        self.counter2 = {'name': '公交总数量（一线城市）', 'value': 6805564}
        self.echart1_data = {
            'title': '行业分布',
            'data': [
                {
        ...
        self.echarts3_1_data = {
            'title': 'IT互联网行业',
            'data': [
                {"name": "软件", "value": 977084},
                {"name": "电视", "value": 106294},
                {"name": "其他", "value": 258712},
            ]
        }
